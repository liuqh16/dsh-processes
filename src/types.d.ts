...
export declare const PROCESS_STATUSES: readonly ["running", "terminating", "finished", "failed", "killed", "terminate_timeout"];
...
export declare const PROCESS_STREAMS: readonly ["stdout", "stderr", "both"];
...
export declare const PROCESS_MATCH_MODES: readonly ["literal", "regex"];
...
export declare const NOTIFY_ATTENTIONS: readonly ["turn", "context", "ignore"];
/**
...
export declare const WATCH_UPDATE_MODES: readonly ["append", "replace", "remove", "clear"];
...
export declare const PROCESS_SORTS: readonly ["startTime_desc", "startTime_asc", "name_asc", "name_desc", "status_asc"];
/** One list sort order. */
